//
//  ViewControllerForUSwarehouseTabBar.m
//  bidmongol
//
...
@interface ViewControllerForUSwarehouseTabBar ()
{
...
@implementation ViewControllerForUSwarehouseTabBar
...
{
    [self performSegueWithIdentifier:@"detailCustomerShowUS" sender:self];
}
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    if ([segue.identifier isEqualToString:@"detailCustomerShowUS"]) {
        NSIndexPath *indexPath = [self.customerList indexPathForSelectedRow];
        ViewControllerForUSwarehouseTabBarDetail *vc4 = segue.destinationViewController;
